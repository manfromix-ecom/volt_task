...
export interface Store<S = any, A extends Action = Action, N = never> {
   ...
   * middleware. For example, see the documentation for the `store-thunk`
   * package. Even the middleware will eventually dispatch plain object
   * actions using this method.
   *
   * @param action A plain object representing “what changed”. It is a good
   *   idea to keep actions serializable so you can record and replay user
   *   sessions, or use the time travelling `store-devtools`. An action must
 ...
 * action payload.
 *
 * See `store-thunk` package as an example of the Redux middleware.
 *
